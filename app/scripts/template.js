angular.module('unchatbar-stream').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/unchatbar-stream/client/list.html',
  ...
  $templateCache.put('views/unchatbar-stream/client/selected.html',
  ...
  $templateCache.put('views/unchatbar-stream/group/add.html',
  ...
  $templateCache.put('views/unchatbar-stream/group/list.html',
    "<div>\n" +
  ...
  $templateCache.put('views/unchatbar-stream/group/selected.html',
  ...
  $templateCache.put('views/unchatbar-stream/index.html',
    "<div>\n" +
    "\n" +
